...
def attempt(version: int, prev_hash: bytes, creation_time: int, entries: tuple[BCHTEntry], maximum_tries: int = 4294967295, powf: typing.Callable = validate_block_hash) -> (typing.Union[BCHTBlock, None], int):
    ...
    maximum_tries : int, optional
        Maximum tries of the proof-of-work, by default and must not exceed 4294967295.
